...
export type MarkerIndexGenerator = number[] | ((count: number) => number);

export type MarkerStylingFunction = (clusterMarker: naver.maps.Marker | null, count: number) => void;
  ...
  constructor($naver: typeof naver, options: MarkerClusteringOptions) {
    class MarkerClustering extends $naver.maps.OverlayView {
      ...
      getOptions(key: string): any {
        ...
        Object.entries(_this.DEFAULT_OPTIONS).forEach(([k, _]) => {
